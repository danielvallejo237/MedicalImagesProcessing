...
def EQMethod(source,se,iterations=None,flatdim=3,filtro=None,gt=None,read_binary=False) -> array:
    try:
...
def EvaluateMetrics(y_pred,y,asdict=True) -> any:
    ...
    if asdict:
        ...
        return np.asarray([acc,prec_pos,specificity,jaccard,roccurve])
